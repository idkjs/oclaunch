...
(* OASIS_START *)
(* DO NOT EDIT (digest: cbde9550f49092df871aa758083774bb) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "W\1977\253\1856hd\175\188\027{\163\nT,";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
